...
- **Architecture:** [docs/architecture/README.md](../architecture/README.md) - S1mpleTrader system design and navigation
- **pgmcp Reference:** [.pgmcp/docs/reference/README.md](../../.pgmcp/docs/reference/README.md) - Workflow tooling, templates, and examples

## Support

**Questions about standards?**
- Check relevant document first
- Look for examples in existing code and the [.pgmcp reference documentation](../../.pgmcp/docs/reference/README.md)
